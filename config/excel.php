...
return array(
    ...
    'properties' => array(
        'creator'        => 'Labmanager System',
        'lastModifiedBy' => 'PEERHealthMDRTB-Administrator',
        'title'          => 'Spreadsheet',
        'description'    => 'Default spreadsheet export',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'mdrtb labmanager, excel, export',
        'category'       => 'Excel',
        'manager'        => 'Dr dr Andani eka putra M.Sc',
        'company'        => 'PEERHealth-MDRTB Laboratory',
    ),
