			...
			<div class="answer">
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks32" id="ks32a1" value="ya" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks32" id="ks32a2" value="tidak" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks32" id="ks32a3" value="" type="radio" class="radio-col-light-green"/>
	...
	<div class="row clearfix p-l-25">
		<div class="col-md-12 m-t-15">
			...
			<div class="answer">
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks33" id="ks33a1" value="ya" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks33" id="ks33a2" value="tidak" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks33" id="ks33a3" value="" type="radio" class="radio-col-light-green"/>
	...
	<div class="row clearfix p-l-25">
		<div class="col-md-12 m-t-15">
			...
			<div class="answer">
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks34" id="ks34a1" value="ya" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks34" id="ks34a2" value="tidak" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks34" id="ks34a3" value="" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-7" style="margin-bottom: 0">
						<div class="input-group" style="margin-bottom: 0">
							...
							<div class="form-line">
								<input class="form-control align-center" name="ks35" value="" placeholder="umur" type="text">
							</div>
							<span class="input-group-addon">
	...
	<div class="row clearfix p-l-25">
		<div class="col-md-12 m-t-15">
			...
			<div class="answer">
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks36" id="ks36a1" value="ya" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks36" id="ks36a2" value="tidak" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks36" id="ks36a3" value="tidak tahu" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks36" id="ks36a4" value="" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-5" style="margin-bottom: 0">
						<div class="input-group" style="margin-bottom: 0">
							...
							<div class="form-line">
								<input class="form-control align-center" name="ks37" value="" placeholder="jumlah" type="text">
							</div>
							<span class="input-group-addon">
	...
	<div class="row clearfix p-l-25">
		<div class="col-md-12 m-t-15">
			...
			<div class="answer">
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks38" id="ks38a1" value="Kurang dari 1 Thn" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks38" id="ks38a2" value="Lebih dari 1 Thn" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks38" id="ks38a3" value="" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-5" style="margin-bottom: 0">
						<div class="input-group" style="margin-bottom: 0">
							...
							<div class="form-line">
								<input class="form-control align-center" name="ks39" value="" type="text">
							</div>
							<span class="input-group-addon">
				...
				<div class="row clearfix">
					<div class="col-md-6" style="margin-bottom: 0">
						<div class="input-group" style="margin-bottom: 0">
							...
							<div class="form-line">
								<input class="form-control align-center" name="ks40" value="" type="text">
							</div>
							<span class="input-group-addon">
				...
				<div class="row clearfix">
					<div class="col-md-5" style="margin-bottom: 0">
						<div class="input-group" style="margin-bottom: 0">
							...
							<div class="form-line">
								<input class="form-control align-center" name="ks41" value="" type="text">
							</div>
							<span class="input-group-addon">
