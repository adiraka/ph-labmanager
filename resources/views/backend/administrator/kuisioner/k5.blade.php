			...
			<div class="answer">
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks42" id="ks42a1" value="ya" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks42" id="ks42a2" value="tidak" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks42" id="ks42a3" value="" type="radio" class="radio-col-light-green"/>
	...
	<div class="row clearfix p-l-25">
		<div class="col-md-12 m-t-15">
			...
			<div class="answer">
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks43a" id="ks43aa1" value="kurang dari 3 Org" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks43a" id="ks43aa2" value="lebih dari 3 Org" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-12" style="margin-bottom: 0">
						<input name="ks43a" id="ks43a3" value="" type="radio" class="radio-col-light-green"/>
				...
				<div class="row clearfix">
					<div class="col-md-5" style="margin-bottom: 0">
						<div class="input-group" style="margin-bottom: 0">
							...
							<div class="form-line">
								<input class="form-control" name="ks43b" value="" type="text">
							</div>
							<span class="input-group-addon">
